...
public class StringUtils_camel {
	...
	public static void main( String[] args ){
		System.out.println( "1驼峰转非驼峰： " + camelToUnderline( "StringStrStr1" ) );
		System.out.println( "2驼峰转非驼峰： " + camel2Underline( "StringStrStr2" ) );
		System.out.println( "3驼峰转非驼峰： " + camel2UnderLine( "StringStrStr3" ) );
		System.out.println( "4转驼峰： " + underLine2Camel( "atring_str_str4" ) );
		System.out.println( "5转驼峰： " + underline2Camel( "atring_str_str5" ) );
		System.out.println( "6驼峰转非驼峰： " + camelToUnderline( "stringStrStr1" ) );
		System.out.println( "7驼峰转非驼峰： " + camel2Underline( "stringStrStr2" ) );
		System.out.println( "8驼峰转非驼峰： " + camel2UnderLine( "stringStrStr3" ) );
		System.out.println( "9转驼峰： " + underLine2Camel( "_atring_str_str4" ) );
		System.out.println( "0转驼峰： " + underline2Camel( "_atring_str_str5" ) );
	}
